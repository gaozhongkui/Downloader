package com.almighty.downloader.search

import com.almighty.downloader.browser.di.SuggestionsClient
import com.almighty.downloader.log.Logger
import com.almighty.downloader.preference.UserPreferences
import com.almighty.downloader.search.engine.AskSearch
import com.almighty.downloader.search.engine.BaiduSearch
import com.almighty.downloader.search.engine.BaseSearchEngine
import com.almighty.downloader.search.engine.BingSearch
import com.almighty.downloader.search.engine.CustomSearch
import com.almighty.downloader.search.engine.DuckLiteSearch
import com.almighty.downloader.search.engine.DuckSearch
import com.almighty.downloader.search.engine.GoogleSearch
import com.almighty.downloader.search.engine.NaverSearch
import com.almighty.downloader.search.engine.StartPageMobileSearch
import com.almighty.downloader.search.engine.StartPageSearch
import com.almighty.downloader.search.engine.YahooSearch
import com.almighty.downloader.search.engine.YandexSearch
import com.almighty.downloader.search.suggestions.BaiduSuggestionsModel
import com.almighty.downloader.search.suggestions.DuckSuggestionsModel
import com.almighty.downloader.search.suggestions.GoogleSuggestionsModel
import com.almighty.downloader.search.suggestions.NaverSuggestionsModel
import com.almighty.downloader.search.suggestions.NoOpSuggestionsRepository
import com.almighty.downloader.search.suggestions.RequestFactory
import com.almighty.downloader.search.suggestions.SuggestionsRepository
