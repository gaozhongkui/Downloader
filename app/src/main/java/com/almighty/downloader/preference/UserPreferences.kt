package com.almighty.downloader.preference

import com.almighty.downloader.AppTheme
import com.almighty.downloader.browser.proxy.ProxyChoice
import com.almighty.downloader.browser.search.SearchBoxDisplayChoice
import com.almighty.downloader.browser.search.SearchBoxModel
import com.almighty.downloader.constant.DEFAULT_ENCODING
import com.almighty.downloader.constant.SCHEME_BOOKMARKS
import com.almighty.downloader.device.ScreenSize
import com.almighty.downloader.browser.di.UserPrefs
...
import com.almighty.downloader.browser.view.RenderingMode
import com.almighty.downloader.preference.delegates.booleanPreference
import com.almighty.downloader.preference.delegates.enumPreference
import com.almighty.downloader.preference.delegates.intPreference
import com.almighty.downloader.preference.delegates.nullableStringPreference
import com.almighty.downloader.preference.delegates.stringPreference
