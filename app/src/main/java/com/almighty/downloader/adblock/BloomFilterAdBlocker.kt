package com.almighty.downloader.adblock

import com.almighty.downloader.R
import com.almighty.downloader.adblock.source.HostsDataSourceProvider
import com.almighty.downloader.adblock.source.HostsResult
import com.almighty.downloader.adblock.util.BloomFilter
import com.almighty.downloader.adblock.util.DefaultBloomFilter
import com.almighty.downloader.adblock.util.DelegatingBloomFilter
import com.almighty.downloader.adblock.util.`object`.JvmObjectStore
import com.almighty.downloader.adblock.util.`object`.ObjectStore
import com.almighty.downloader.adblock.util.hash.MurmurHashHostAdapter
import com.almighty.downloader.adblock.util.hash.MurmurHashStringAdapter
import com.almighty.downloader.database.adblock.Host
import com.almighty.downloader.database.adblock.HostsRepository
import com.almighty.downloader.database.adblock.HostsRepositoryInfo
import com.almighty.downloader.browser.di.DatabaseScheduler
import com.almighty.downloader.browser.di.MainScheduler
import com.almighty.downloader.extensions.toast
